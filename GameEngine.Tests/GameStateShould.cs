...
namespace GameEngine.Tests
{
    public class GameStateShould : IClassFixture<GameStateFixture>
    {
        ...
        {
            this._gameStateFixture = gameStateFixture;
            this._output = output;
        }
        ...
        public void DamageAllPlayerWhenEarthquake()
        {
            ...
            var expectedHealthAfterEarchquake = player1.Health - GameState.EarthquakeDamage;

            _gameStateFixture.State.Earthquake();

            Assert.Equal(expectedHealthAfterEarchquake, player1.Health);
            Assert.Equal(expectedHealthAfterEarchquake, player2.Health);
        }
